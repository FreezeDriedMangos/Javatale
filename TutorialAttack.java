...
public class TutorialAttack extends Attack{
    public TutorialAttack(int attack, BoxLabel box, JLayeredPane panel, Soul soul){
        ...
        if(attack == 1){
            ...
            Projectile template = new Projectile("imgs/lightning.png", 0,0, new Vector(1.5, 0), 1);
            ...
            projectileManagers.add(new GreenSoulPM(panel, "imgs/lightning.png", new int[]{4,4,4,1,2}, 20, 1, 1, soul));
        } else if(attack == 7){
            ...
            SetVelocityPM pm = new SetVelocityPM(panel);
            Projectile template = new Projectile("imgs/lightning.png", 0,0, new Vector(-1.5, Math.PI * 3/2), 1);
